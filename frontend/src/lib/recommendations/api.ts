 ...
 */
export const getProfileTemplate = async (): Promise<ProfileTemplateResponse> => {
 ...
 */
export const getCatalogueTemplate = async (): Promise<CatalogueTemplateResponse> => {
 ...
 */
export const getStylePreferences = async (): Promise<StylePreferencesResponse> => {
...
export const createQuickRecommendationRequest = (
  ...
  if (!profile.session_id || !profile.style_words || !profile.occasion || !profile.budget_range) {
    throw new Error('Missing required fields for quick recommendations: session_id, style_words, occasion, budget_range');
  }
 ...
 */
export const formatUserProfileForApi = (profile: Partial<UserProfile>): Partial<UserProfile> => {
 ...
 */
export const formatCatalogueItems = (items: Partial<CatalogueItem>[]): CatalogueItem[] => {
...
export const isApiError = (error: unknown): error is ApiError => {
  return typeof error === 'object' && error !== null && 'success' in error && 'error' in error;
};
