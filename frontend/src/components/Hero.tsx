...
export const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
            Take a photo, describe what you want, and watch our AI create the
            perfect virtual try-on experience with personalized style
            recommendations.
          </p>
      ...
      <div
        className="absolute bottom-20 right-10 w-6 h-6 bg-primary rounded-full opacity-40 animate-float"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-20 w-3 h-3 bg-white rounded-full opacity-30 animate-float"
